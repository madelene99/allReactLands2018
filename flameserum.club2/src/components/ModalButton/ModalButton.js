            ...
            <div className="offer-products">
            			<div className="offer-product">
            				...
            				<div className="offer-description">
            					...
            					<div className="offer-curr-price">AED 147</div>
                      <div className="offer-prev-price"><span>was AED 187</span> (Save AED 40)</div>
            				...
            				<div className="offer-description">
            					...
            					<div className="offer-curr-price">AED 222</div>

            					<div className="offer-special">AED 111/each   </div>
                      <div className="offer-prev-price"><span>was AED 374</span> (Save AED 152)</div>
            				</div>
            			</div>
                  ...
                  <div className="offer-curr-price">AED 297</div>
                  <div className="offer-special">AED 99/each </div>
                  <div className="offer-prev-price"><span>was AED 561</span> (Save AED 264)</div>
                  </div>
                </div>
            				...
            				<div className="offer-description">
            					...
            					<div className="offer-curr-price">AED 372</div>

            					<div className="offer-special">AED 93/each </div>
                      <div className="offer-prev-price"><span>was AED 748</span> (Save AED 376)</div>
            				</div>
            			</div>
            		</div>
