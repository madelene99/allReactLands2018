...
query_posts('cat=4');
query_posts('cat=4'.'&'.$order); // базовый запрос + свои параметры
...
<script type="text/javascript">
    ...
    link1_1="https://test-dani-aar.myshopify.com/cart/15418529906778:1?channel=buy_button"; //1 heating Vest M
    link1_2="https://test-dani-aar.myshopify.com/cart/15418529939546:1?channel=buy_button"; //1 heating Vest L
    link1_3="https://test-dani-aar.myshopify.com/cart/15418529972314:1?channel=buy_button"; //1 heating Vest XL
    link1_4="https://test-dani-aar.myshopify.com/cart/15418530005082:1?channel=buy_button"; //1 heating Vest XXL
    link1_5="https://test-dani-aar.myshopify.com/cart/15418530037850:1?channel=buy_button"; //1 heating Vest XXXL
    ...
    link2_1="link2_1"; //2+1 heating Vest M
   

    link2_2="link2_2"; //2+1 heating Vest L
    link2_3="link2_3"; //2+1 heating Vest XL
    link2_4="link2_4"; //2+1 heating Vest XXL
    link2_5="link2_5"; //2+1 heating Vest XXXL





    link2_1="https://test-dani-aar.myshopify.com/cart/15418531545178:2,15413753282650:1?channel=buy_button"; //2+1 heating Vest M
    link2_2="https://test-dani-aar.myshopify.com/cart/15418531577946:2,15413753315418:1?channel=buy_button"; //2+1 heating Vest L
    link2_3="https://test-dani-aar.myshopify.com/cart/15418531610714:2,15413753348186:1?channel=buy_button"; //2+1 heating Vest XL
    link2_4="https://test-dani-aar.myshopify.com/cart/15418531643482:2,15413753380954:1?channel=buy_button"; //2+1 heating Vest XXL
    link2_5="https://test-dani-aar.myshopify.com/cart/15418531676250:2,15413753413722:1?channel=buy_button"; //2+1 heating Vest XXXL
    ...
    link3_1="https://test-dani-aar.myshopify.com/cart/15418529906778:1,15413755379802:1?channel=buy_button"; //1+1 heating Vest M
    link3_2="https://test-dani-aar.myshopify.com/cart/15418529939546:1,15413755412570:1?channel=buy_button"; //1+1 heating Vest L
    link3_3="https://test-dani-aar.myshopify.com/cart/15418529972314:1,15413755445338:1?channel=buy_button"; //1+1 heating Vest XL
    link3_4="https://test-dani-aar.myshopify.com/cart/15418530005082:1,15413755478106:1?channel=buy_button"; //1+1 heating Vest XXL
    link3_5="https://test-dani-aar.myshopify.com/cart/15418530037850:1,15413755510874:1?channel=buy_button"; //1+1 heating Vest XXXL
 
 
 


 linkbuild1_m="15418529906778";// vest+shipping
 linkbuild1_l="15418529939546";// vest+shipping
 linkbuild1_xl="15418529972314";// vest+shipping
 linkbuild1_xxl="15418530005082";// vest+shipping
 linkbuild1_xxxl="15418530037850";// vest+shipping
 

 linkbuild2_m="15418531545178";//  Vest  Free shipping
 linkbuild2_l="15418531577946";//  Vest  Free shipping
 linkbuild2_xl="15418531610714";//  Vest  Free shipping
 linkbuild2_xxl="15418531643482";//  Vest  Free shipping
 linkbuild2_xxxl="15418531676250";//  Vest  Free shipping
 


 linkbuild3_m="15413753282650";// FREE vest
 linkbuild3_l="15413753315418";// FREE vest
 linkbuild3_xl="15413753348186";// FREE vest
 linkbuild3_xxl="15413753380954";// FREE vest
 linkbuild3_xxl="15413753413722";// FREE vest
 


 linkbuild4_m="15413755379802";// 50% vest
 linkbuild4_m="15413755412570";// 50% vest
 linkbuild4_m="15413755445338";// 50% vest
 linkbuild4_m="15413755478106";// 50% vest
 linkbuild4_m="15413755510874";// 50% vest
 
quantities="2";
mainshipfy="https://test-dani-aar.myshopify.com/cart/";
 
linkbuildlast=mainshipfy+linkbuild1_m+":"+quantities+","+linkbuild4_m+":"+quantities+"?channel=buy_button";
...
$(".case-offer2").click(function(event) {
    
        console.log(linkbuildlast);
