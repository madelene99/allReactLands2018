...
content: " ";
    width: 30px;
    height: 41px;
    background: url(https://1693021541.rsc.cdn77.org/lands/vest/uploads/2018/11/checkmark-blue-03.png) no-repeat center;
        margin-left: -40px;
        margin-left: -36px;
        position: absolute;
...
<div class="footer">
			...
			<div class="pay-icons">
				<img  class=lazy src="https://1693021541.rsc.cdn77.org/lands/vest/opt/pay-ics.jpg" data-original="https://1693021541.rsc.cdn77.org/lands/vest/uploads/2018/11/pay-ics.png" alt=""  >
			</div>
...
<script type="text/javascript">
	...
	link1_1="https://test-dani-aar.myshopify.com/cart/15407094136922:1?channel=buy_button"; //1 heating Vest M
	link1_2="https://test-dani-aar.myshopify.com/cart/15407094169690:1?channel=buy_button"; //1 heating Vest L
	link1_3="https://test-dani-aar.myshopify.com/cart/15407094202458:1?channel=buy_button"; //1 heating Vest XL
	link1_4="https://test-dani-aar.myshopify.com/cart/15407094235226:1?channel=buy_button"; //1 heating Vest XXL
	link1_5="https://test-dani-aar.myshopify.com/cart/15407094267994:1?channel=buy_button"; //1 heating Vest XXXL

	link2_1="https://test-dani-aar.myshopify.com/cart/15407094136922:2,15413753282650:1?channel=buy_button"; //2+1 heating Vest M
	link2_2="https://test-dani-aar.myshopify.com/cart/15407094169690:2,15413753315418:1?channel=buy_button"; //2+1 heating Vest L
	link2_3="https://test-dani-aar.myshopify.com/cart/15407094202458:2,15413753348186:1?channel=buy_button"; //2+1 heating Vest XL
	link2_4="https://test-dani-aar.myshopify.com/cart/15407094235226:2,15413753380954:1?channel=buy_button"; //2+1 heating Vest XXL
	link2_5="https://test-dani-aar.myshopify.com/cart/15407094267994:2,15413753413722:1?channel=buy_button"; //2+1 heating Vest XXXL

	link3_1="https://test-dani-aar.myshopify.com/cart/15407094136922:1,15413755379802:1?channel=buy_button"; //1+1 heating Vest M
	link3_2="https://test-dani-aar.myshopify.com/cart/15407094169690:1,15413755412570:1?channel=buy_button"; //1+1 heating Vest L
	link3_3="https://test-dani-aar.myshopify.com/cart/15407094202458:1,15413755445338:1?channel=buy_button"; //1+1 heating Vest XL
	link3_4="https://test-dani-aar.myshopify.com/cart/15407094235226:1,15413755478106:1?channel=buy_button"; //1+1 heating Vest XXL
	link3_5="https://test-dani-aar.myshopify.com/cart/15407094267994:1,15413755510874:1?channel=buy_button"; //1+1 heating Vest XXXL
 		...
 		function p1(){
 				console.log("1 product");
 					...
 					if($("#L1").is(':checked')){
 							...
 							$(".lastone").attr({	"href": link1_2	});	
 					}
 					if($("#XL1").is(':checked')){

 							$(".lastone").attr({	"href": link1_3	});	
 					}
 					if($("#XXL1").is(':checked')){

 							$(".lastone").attr({	"href": link1_4	});	
 					}
 					if($("#XXXL1").is(':checked')){

 							$(".lastone").attr({	"href": link1_5	});	
 					}
 			}
 		...
 		function p2(){
 				console.log("2+1 product");
 					...
 					if($("#L2").is(':checked')){
 							...
 							$(".lastone").attr({	"href": link2_2	});	
 					}
 					if($("#XL2").is(':checked')){

 							$(".lastone").attr({	"href": link2_3	});	
 					}
 					if($("#XXL2").is(':checked')){

 							$(".lastone").attr({	"href": link2_4	});	
 					}
 					if($("#XXXL2").is(':checked')){

 							$(".lastone").attr({	"href": link2_5	});	
 					}
 			}

 			function p3(){
 				console.log("1+1 product");
 					if($("#M3").is(':checked')){
 					...
 					if($("#L3").is(':checked')){
 							...
 							$(".lastone").attr({	"href": link3_2	});	
 					}
 					if($("#XL3").is(':checked')){

 							$(".lastone").attr({	"href": link3_3	});	
 					}
 					if($("#XXL3").is(':checked')){

 							$(".lastone").attr({	"href": link3_4	});	
 					}
 					if($("#XXXL3").is(':checked')){

 							$(".lastone").attr({	"href": link3_5	});	
 					}
 			}
	//}
