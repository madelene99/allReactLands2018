...
'https://connect.facebook.net/en_US/fbevents.js');
 fbq('init', '320441718515156'); 
fbq('track', 'PageView');
 fbq('track', 'ViewContent');
</script>
<noscript>
 <img height="1" width="1" 
src="https://www.facebook.com/tr?id=320441718515156&ev=PageView
&noscript=1"/>
</noscript>
<!-- End Facebook Pixel Code -->
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-129497023-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-129497023-1');
</script>
...
query_posts('cat='.$combo);
query_posts('cat='.$combo.'&'.$order); // базовый запрос + свои параметры


        if ( have_posts('cat='.$combo) ) :
...
.selected{
        background: #d9f6ff;
    border-color: #0071a8;    transform: scale(1);
}
