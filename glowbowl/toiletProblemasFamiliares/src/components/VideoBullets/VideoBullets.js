...
return (
  <div className="VideoBullets">
      <TitleH1 title="Hablar con un PSICOLOGO ONLINE puede ayudarte a resolver los conflictos familiares y mejorar la relación entre los miembros de la familia." />
