...
return (
  <div className="BulletsAndImages">
      <div className="Bullets">
         <div className="TitleH1 mob" style={{fontStyle:"italic",color:"#009cff", borderTop:"1px solid #ccc", borderBottom:"1px solid #ccc",padding:"20px 0px",    margin: "26px auto", textAlign: "center"}} > Plus de 30 000 vendus!</div>
       <div class="TitleH1" id="h3"> 7 modes de traitement différents - une technologie de l'ère spatiale éprouvée en 
       clinique qui <b>pénètre la peau sans douleur en utilisant la lumière à différentes longueurs d'onde. </b> </div>

          <div className="Bullets__ul">
              <ul>
                <li>Salon spa chez vous presque gratuitement!</li>
                <li>Produit un effet de beauté plus rapide, plus profond et efficace</li>
                <li>Couvre tout le visage, couvre également la région du cou</li>
                
                

              </ul>
          </div>
 <div class="TitleH1" id="h3"> C’est l’appareil <b>de beauté indispensable pour tous!</b></div>
...
<br />3. Not to be used on pregnant women, children, epileptic sufferers or anyone who has thyroid disease. We recommend asking your doctor’s advice before starting your light therapy treatments. 
        ...
        <a href="#Offer">
            <div className="Bullets__button btn">Réclamez votre rabais de 90 $ maintenant! </div>
          </a>
