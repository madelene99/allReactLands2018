...
<img src="https://1693021541.rsc.cdn77.org/lands/led/promo.png" style={{marginTop:20, width:"100%"}} />     
   <br /  >
<div class="TitleH1" id="h2">Por favor, guarda el código de promoción y llena el formulario con tu nombre y número de teléfono. Nuestro consultor lo llamará, responderá sus preguntas y le ayudará a canjear su código de descuento.</div>
   </div>
   ...
   <input type="hidden" name="version" className="p" value="es2" />
   <input type="hidden" name="best" className="p" value={this.state.best} />
  
                <div className="buyitr"><button type="submit"   className="btn blabtn"> Solicita Ahora tu descuento de $50!  </button></div>
                ...
                <div className="buyitr"><a href="https://test-dani-aar.myshopify.com/cart/16191609045082:1?channel=buy_button" className="btn" >Pagar el precio completo! </a></div>
       </form>
</div>
