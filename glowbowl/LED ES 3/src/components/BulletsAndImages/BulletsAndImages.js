...
return (
  <div className="BulletsAndImages">
      <div className="Bullets">
         <div className="TitleH1 mob" style={{fontStyle:"italic",color:"#009cff", borderTop:"1px solid #ccc", borderBottom:"1px solid #ccc",padding:"20px 0px",    margin: "26px auto", textAlign: "center"}} > ¡Más de 30,000 Vendidas!</div>
