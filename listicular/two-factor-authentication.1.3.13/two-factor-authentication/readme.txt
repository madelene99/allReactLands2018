...
Secure WordPress login with this two factor authentication (TFA) plugin. Users for whom it is enabled will require a one-time code in order to log in. From the authors of <a href="https://updraftplus.com/">UpdraftPlus - WP's #1 backup/restore plugin</a>, with over a million active installs.
...
== Upgrade Notice ==
* 1.3.13 : Security fix (see changelog for details); recommended update for all.
