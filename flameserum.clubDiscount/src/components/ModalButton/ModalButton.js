...
onDiscountChange = (e) => {
 ...
 onChange = (e) => {
  ...
  <form className={this.state.visibleDiscount}>
       ...
       <Form layout={formLayout}  className={this.state.visibleForm}  action="https://flameserum.club/thanks-hairflame/" method="GET" onSubmit={this.handleSubmit}>
      ...
      <RadioGroup onChange={this.onChange} value={this.state.value}>
              <Radio style={radioStyle}  value={1}>1 for AED 147   <div className="showtext">Save 40 AED</div></Radio>
              <Radio style={radioStyle}  value={2}>2 for AED 222   <div className="showtext">Save 152 AED</div></Radio>
              <Radio style={radioStyle}  value={3}>3 for AED 297 <div className="showtext">Save 264 AED</div></Radio>
              <Radio style={radioStyle}   value={4}>4 for AED 372 <div className="showtext">Save 376 AED</div></Radio>
            </RadioGroup>
      ...
      <Input type="hidden" id="aff_sub1" className="aff_sub1" name="affsub1" value={this.state.gart} />
       ...
       <Input type="hidden" id="version" className="version" name="version" value="version-hairflame1d1" />
