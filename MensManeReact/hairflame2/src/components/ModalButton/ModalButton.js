  ...
  render(){
    ...
    const { classNames, btntext } = this.props
      ...
      return (
       ...
       <Form layout={formLayout} action="https://mens-mane.com/thanks/" method="GET" onSubmit={this.handleSubmit}>
            ...
            <div className="offer-products">
            			<div className="offer-product">
            				...
            				<div className="offer__img">
            					<img  src="https://1693021541.rsc.cdn77.org/lands/mens/set.png"   alt="" />
            				</div>
            				<div className="offer-description">
            					<div className="offer-title">1 Men's Mane</div>
                      ...
                      <div className="offer-prev-price"><span>was AED 207</span> (Save AED 40)</div>
            				...
            				<div className="offer-description">
            					<div className="offer-title">2 Men's Mane</div>
                  ...
                  <div className="offer-description">
                  <div className="offer-title">3 Men's Mane</div>
                  ...
                  <div className="offer-prev-price"><span>was AED 621</span> (Save AED 304)</div>
            				...
            				<div className="offer-description">
            					<div className="offer-title">4 Men's Mane</div>
      ...
      <Input type="hidden" id="aff_sub1" className="aff_sub1" name="affsub1" value={this.state.gart} />
       ...
       <Input type="hidden" id="version" className="version" name="version" value="version-mensMane2" />
