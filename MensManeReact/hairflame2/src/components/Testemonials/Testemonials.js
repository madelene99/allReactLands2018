...
export default class Testemonials extends Component {
  ...
  render(){
  const {Testemonials_h1, comment4_img, comment4_p1, comment4_p2, comment4_name, comment3_img, comment3_p1, comment3_p2, comment3_name, comment2_img, comment2_p1, comment2_p2, comment2_name, comment1_p1, comment1_p2, comment1_p3, comment1_img, comment1_name, comment5_p1,  comment5_p2, comment5_img, comment5_name} = this.props.db
    ...
    return(
      ...
      <section>
       ...
       <div>
          <img src={comment5_img} alt="Comment 1" />
          <p>{comment5_p1}</p>

          <p style={{"fontWeight":"Bold"}}>{comment5_p2}</p>
          <p className="CommentName">{comment5_name}</p>
       </div>
      </Carousel>
</section>
    </div>
